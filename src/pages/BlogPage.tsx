...
const BlogPage: React.FC = () => {
  ...
  return (
    <div>
      <Hero 
        title="Cosplay Blog"
        subtitle="Articles, tutorials, and insights from the cosplay community"
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="container mx-auto">
          <SectionHeading 
            ...
            subtitle="Stay up to date with the latest cosplay trends, techniques, and stories"
          />
          ...
          {filteredArticles.length === 0 && (
            <div className="py-16 text-center">
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-4">No articles found matching your search</p>
              <button
                onClick={() => {
                  setSearchTerm('');
                  setSelectedCategory('');
