    ...
    <div>
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="container mx-auto">
          <SectionHeading
            title="Изучайте косплеи"
            subtitle="Вдохновляйтесь и цените искусство косплееров"
          />
          ...
          <div className="mb-8 flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-grow">
              ...
              <input
                type="text"
                placeholder="Поиск по персонажу, косплееру или тегу..."
                value={searchTerm}
          ...
          <p className="mb-6 text-gray-600 dark:text-gray-400">
            Показано {filteredCosplays.length} из {allCosplays.length} косплеев
          </p>
          ...
          {filteredCosplays.length === 0 && (
            <div className="py-16 text-center">
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-4">
                Косплеи, соответствующие фильтрам, не найдены
              </p>
              <button
                onClick={clearFilters}
